...
import { MIN_RATING, REVIEW_COMMENT_MIN_LENGTH, REVIEW_COMMENT_MAX_LENGTH } from '../../../../const.ts';
import {ReviewFormProps} from '@pages/offer/reviews/review-form/review-form-props.ts';
