                          ...
                          <article key={favorite.id} className="favorites__card place-card">
                            ...
                            <div className="favorites__image-wrapper place-card__image-wrapper">
                              <Link to={`${AppRoute.Offer}/${favorite.id}`}>
                                <img className="place-card__image" src={favorite.imageSrc} width="150" height="110" alt="Place image" />
                              </Link>
                            </div>
                            <div className="favorites__card-info place-card__info">
                              ...
                              <div className="place-card__rating rating">
                                <div className="place-card__stars rating__stars">
                                  <span style={{ width: `${(favorite.starsCount / 5) * 100}%` }}></span>
                              ...
                              <p className="place-card__type">{favorite.cardType[0].toUpperCase() + favorite.cardType.substring(1)}</p>
                            </div>
                          </article>
                        ))}
                    </div>
