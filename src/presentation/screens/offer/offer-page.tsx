...
import MemoizedNotFoundPage from '../not-found/not-found';
import MemoizedMap from '../main/components/map';
...
import MemoizedLoadingScreen from '../main/components/loading-screen';
